...
const CampaignSlide = () => {
  return (
    <div>
      <section className="campaign-section md:px-20 py-20">
        <Swiper
        ...
        >
          ...
          <SwiperSlide className="!py-20">
            <div className="p-16 rounded-[50px] bg-black flex items-center justify-between relative pr-0 h-[500px] text-white">
              <div className="max-w-[40%]">
                ...
                <p className="mt-10 text-xl leading-[1.3]">
              ...
              <div className="img h-[600px] w-[600px] relative z-20">
                <img
          ...
          {/* Slider 2 */}
          <SwiperSlide className="!py-20">
            <div className="p-16 rounded-[50px] bg-[#b99174] flex items-center justify-between relative pr-0 h-[500px] text-white">
              <div className="max-w-[40%]">
                <h1 className="text-3xl font-bold leading-[1.3]">
          ...
          {/* Slider 3 */}
          <SwiperSlide className="!py-20">
            <div className="p-16 rounded-[50px] bg-[#F5E3D3] flex items-center justify-between relative pr-0 h-[500px] text-[#1B1F23]">
              <div className="max-w-[40%]">
                <h1 className="text-3xl font-bold leading-[1.3]">
